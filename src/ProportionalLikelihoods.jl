...
function NumericSurvivalProbability1(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n; reltol=1e-8)
    ...
    pquadrature(u1 ->lambdaN(u1, beta, m_basal, m_size, S0)*
...
function NumericSurvivalProbability2(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n; reltol=1e-8)
    ...
    pquadrature(u1 ->lambdaN(u1, beta, m_basal, m_size, S0)*
        Phi(t1, u1, beta, d_size, d_metas, S0, n)*
        pquadrature(u2 -> lambdaN(u2, beta, m_basal, m_size, S0)*
...
function NumericSurvivalProbability3(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n; reltol=1e-8)
    ...
    pquadrature(u1 ->lambdaN(u1, beta, m_basal, m_size, S0)*
        ...
        pquadrature(u2 -> lambdaN(u2, beta, m_basal, m_size, S0)*
            Phi(u1, u2, beta, d_size, d_metas, S0, n+1) *
            pquadrature(u3 -> lambdaN(u3, beta, m_basal, m_size, S0) *
...
function NumericSurvivalProbability4(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n; reltol=1e-8)
    ...
    pquadrature(u1 ->lambdaN(u1, beta, m_basal, m_size, S0)*
        ...
        pquadrature(u2 -> lambdaN(u2, beta, m_basal, m_size, S0)*
            ...
            pquadrature(u3 -> lambdaN(u3, beta, m_basal, m_size, S0) *
                Phi(u2, u3, beta, d_size, d_metas, S0, n+2) *
                pquadrature(u4 -> lambdaN(u4, beta, m_basal, m_size, S0) *
    ...
    pquadrature(u1 ->lambdaN(u1, beta, m_basal, m_size, S0)*
        ...
        pquadrature(u2 -> lambdaN(u2, beta, m_basal, m_size, S0)*
            ...
            pquadrature(u3 -> lambdaN(u3, beta, m_basal, m_size, S0) *
                ...
                pquadrature(u4 -> lambdaN(u4, beta, m_basal, m_size, S0) *
                    Phi(u3, u4, beta, d_size, d_metas, S0, n+3) *
                    pquadrature(u5 -> lambdaN(u5, beta, m_basal, m_size, S0) *
        ...
        pquadrature(u2 -> lambdaN(u2, beta, m_basal, m_size, S0)*
            ...
            pquadrature(u3 -> lambdaN(u3, beta, m_basal, m_size, S0) *
                ...
                pquadrature(u4 -> lambdaN(u4, beta, m_basal, m_size, S0) *
                    ...
                    pquadrature(u5 -> lambdaN(u5, beta, m_basal, m_size, S0) *
                        Phi(u4, u5, beta, d_size, d_metas, S0, n+4) *
                        pquadrature(u6 -> lambdaN(u6, beta, m_basal, m_size, S0) *
...
function ObservationProbability(
    ...
    if lognormal_noise
        ...
        obs_prob = pdf(LogNormal(log(St), sigma), Bt)
    else
        # Compute the likelihood of the tumor size observation
...
function ObservationProbability(
    Xt::Vector{<:Real},
    Yt::Vector{Union{Missing, Float64}}; 
    sigma::Real=0.1, # For now with fixed noise level (can be changed to estimated noise later)
    lognormal_noise::Bool=false
    )::Real
...
# Num1 = NumericSurvivalProbability1(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# An1 = AnalyticSurvivalProbability1(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# FG1 = FGSurvivalProbability1(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# # check if approximately equal
# println("Numeric: ", Num1, "\n", "Analytic: ", An1, "\n", "FG: ", FG1)

# Num2 = NumericSurvivalProbability2(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# An2 = AnalyticSurvivalProbability2(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# FG2 = FGSurvivalProbability2(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# println("Numeric: ", Num2, "\n", "Analytic: ", An2, "\n", "FG: ", FG2)

# Num3 = NumericSurvivalProbability3(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# An3 = AnalyticSurvivalProbability3(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# FG3 = FGSurvivalProbability3(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# println("Numeric: ", Num3, "\n", "Analytic: ", An3, "\n", "FG: ", FG3)

# Num4 = NumericSurvivalProbability4(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# An4 = AnalyticSurvivalProbability4(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# FG4 = FGSurvivalProbability4(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# println("Numeric: ", Num4, "\n", "Analytic: ", An4, "\n", "FG: ", FG4)

# Num5 = NumericSurvivalProbability5(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# An5 = AnalyticSurvivalProbability5(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# FG5 = FGSurvivalProbability5(t1, t2, beta, m_basal, m_size, d_size, d_metas, S0, n)
# println("Numeric: ", Num5, "\n", "Analytic: ", An5, "\n", "FG: ", FG5)
