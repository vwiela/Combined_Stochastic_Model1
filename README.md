...
- `Project.toml`and `Manifest.toml` specifying the used packages in the Julia 1.10.4 environment.
- A script `functionalities.jl` containing useful functions for visualizations. 
...
- One notebook for each model and experiment conducted in the simulation study. Executing the notebook will create or load the data used and visualize the results as seen in the paper.
