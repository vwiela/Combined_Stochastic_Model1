...
- One script for running the model validation.
...
- One notebook for each model and experiment reported in the manuscript. Executing the notebook will create or load the data used and visualize the results as seen in the paper.
